...
import 'package:toprun_application/screens/actors/transporter/add_bid_screen.dart';
...
class DealButton extends StatefulWidget {
  ...
  void _addBid(BuildContext context, DeliveryDetails deliveryObj) {
    print('MAKE OFFER\n');
        ...
        builder: (context) {
          ...
          return FractionallySizedBox(
            ...
            child: Container(
              ...
              child: AddBidScreen(delivery: deliveryObj),
            ),
          );
        });
  }
